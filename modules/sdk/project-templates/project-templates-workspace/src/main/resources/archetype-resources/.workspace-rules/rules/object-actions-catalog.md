...
Consult `learn-lookup docs.objects.validations` for the full expression-builder reference.
...
- Object actions documentation: `learn-lookup docs.objects`
- Validation expression syntax: `learn-lookup docs.objects.validations`
- Notification template API: `/o/notification/v1.0/notification-templates`
- Workflow definitions: `rules/headless-apis.md` (headless-admin-workflow section)
